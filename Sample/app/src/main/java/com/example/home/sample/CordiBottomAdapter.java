...
public class CordiBottomAdapter extends PagerAdapter {

    LayoutInflater inflater;
    String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/cordi/bottom/";
    File file = new File(path);
    private int imgCount;



    public CordiBottomAdapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container2, int position) {
        ...
        view= inflater.inflate(R.layout.viewpager_bottom, null);
        ...
        ImageView img= (ImageView)view.findViewById(R.id.img_viewpager_bottom);
        ...
        //img.setImageResource(R.drawable.haha1+position);
