...
public class Sub1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Button coordiend = sub1.findViewById(R.id.coordiend);
        coordiend.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        Button coordi = sub1.findViewById(R.id.coordi);
        coordi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activity.buttonChange1(3);
            }
        });
