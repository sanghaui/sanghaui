...
public class CordiTopAdapter extends PagerAdapter {

    LayoutInflater inflater;
    String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/cordi/top/";
    File file = new File(path);
    private int imgCount;


    public CordiTopAdapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container2, int position) {
        ...
        view= inflater.inflate(R.layout.viewpager_top, null);
        ...
        ImageView img= (ImageView)view.findViewById(R.id.img_viewpager_top);
