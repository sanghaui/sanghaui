...
public class AllAdapter extends PagerAdapter {
    ...
    String path = Environment.getExternalStorageDirectory().getAbsolutePath()+"/cordi/main/";
    File file = new File(path);
    private int imgCount;

    public AllAdapter(LayoutInflater inflater) {
    ...
    public Object instantiateItem(ViewGroup container2, int position) {
        ...
        view = inflater.inflate(R.layout.viewpager_all, null);
        ...
        ImageView img= (ImageView)view.findViewById(R.id.img_viewpager_all);
